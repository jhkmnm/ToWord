...
namespace ToWord
{
    ...
    public class DataVerifier
    {
        ...
        public DataVerifier(Type customExceptionType) : this(true, customExceptionType, "", new object[0])
        {
        }

        public DataVerifier(bool promptThrowException, Type customExceptionType) : this(promptThrowException, customExceptionType, "", new object[0])
        {
        }

        public DataVerifier(string title, params object[] args) : this(false, null, title, args)
        {
        }

        public DataVerifier(bool promptThrowException, Type customExceptionType, string title, params object[] args) : this()
        {
